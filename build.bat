...
set INCLUDES=/Isrc\ /Iext\ /Iext\freetype\include\ /Iext\assimp\include\
...
set LIBS=/LIBPATH:ext\freetype\libs\x64\Release\ /LIBPATH:ext\assimp\lib\x64\ user32.lib shell32.lib kernel32.lib winmm.lib shlwapi.lib D3D11.lib D3DCompiler.lib freetype.lib assimp-vc143-mt.lib 
